...
// | mymodule                         	| `/bundles/mymodule.js`                	|                        	|
// | deep/folder/structure/with/very/ 	| `/bundles/deep/folder/structure/with/ 	| main bundles arent cut 	|
// 		very-very-very-long-name         	| very/very-very-very-long-name.js`
// | index.stache!done-autorender     	| `/bundles/index.js`                   	|                        	|
// | mymodule!my-plugin               	| `/bundles/mymodule.js`                	|                        	|
//
// ### with bundles
// | module                                                        	| bundled path                                        	| note                                                                                                                                 	|
// |---------------------------------------------------------------	|-----------------------------------------------------	|--------------------------------------------------------------------------------------------------------------------------------------	|
...
// | `["deep/folder/structure/with/very/very-very-very-long-name", 	| `/bundles/very-very-very-l-f802f7c2-[[HASH]].js`    	| [[HASH]] = a unique hash string; concat bundle[0] + bundle[1],cut to 25 chars                                                        	|
