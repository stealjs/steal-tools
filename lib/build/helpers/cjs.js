 ...
 * ## Use
 * 
 * Adding "+cjs" to a [stealTools.grunt.pluginify.output] name will mixin
 * default [stealTools.grunt.pluginify.output] and [steal-tools.pluginify.options]
 * values that export to what a CJS project expects.
 * 
 * ```
 * 
 * ```
