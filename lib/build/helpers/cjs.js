 ...
 * ## Use
 * 
 * Adding "+cjs" to a [steal-tools.exporter.output] name will mixin
 * default [steal-tools.exporter.output] and [steal-tools.pluginify.options]
 ...
 * 
 * You can overwrite or alter the behavior of these default values by adding a value in the [steal-tools.exporter.output].
 ...
 * ```
 * 
 * The behavior for overwriting [steal-tools.exporter.output] values is documented in the default value API pages.
 * 
 */
