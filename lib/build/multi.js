...
var makeBundleGraph = require("../graph/make_graph_with_bundles"),
	...
	nameBundle = require("../bundle/name").setName,
...
module.exports = function(config, options){
	...
	return makeBundleGraph(config).then(function(data){
		...
		pluck(dependencyGraph,"steal/dev");
		...
		var configNode = makeBundlesConfig(splitBundles, options);
		...
		return writeBundles(splitBundles, baseURL, options.distDir);
	}).catch(function(e){
