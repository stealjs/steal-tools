...
@option {Boolean} [noGlobalShim=false] By default, if options.format is 'global' then a shim will be added
for the global define method. Setting this flag to `true` prevents this.
